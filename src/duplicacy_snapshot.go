...
func CreateSnapshotFromDirectory(id string, top string, nobackupFile string, skipOfflineData bool) (snapshot *Snapshot, skippedDirectories []string,
	...
	for len(directories) > 0 {
		...
		subdirectories, skipped, err := ListEntries(top, directory.Path, &snapshot.Files, patterns, nobackupFile, snapshot.discardAttributes, skipOfflineData)
		if err != nil {
